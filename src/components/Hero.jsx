  ...
  return (
    <section
      ...
      style={{
        ...
        background: 'linear-gradient(135deg, #030712 0%, #0a0f1e 60%, #0f172a 100%)',
      }}
    >
      {/* Canvas Grid */}
      ...
      {/* Floating particles */}
      {[
        { width: 6, height: 6, background: '#6366f1', top: '25%', left: '15%', duration: 6, delay: 0 },
        { width: 4, height: 4, background: '#a855f7', top: '60%', left: '8%', duration: 8, delay: 1 },
        { width: 5, height: 5, background: '#22d3ee', top: '35%', right: '20%', duration: 7, delay: 0.5 },
        { width: 8, height: 8, background: '#6366f1', bottom: '30%', right: '12%', duration: 5, delay: 2 },
        { width: 3, height: 3, background: '#a855f7', top: '70%', left: '45%', duration: 9, delay: 1.5 },
      ].map((p, i) => (
        <Particle key={i} style={{ ...p, opacity: 0.4, boxShadow: `0 0 10px ${p.background}` }} />
      ))}

      {/* Main content */}
      <div style={{ position: 'relative', zIndex: 10, maxWidth: 1200, margin: '0 auto', padding: '120px 2rem 80px', width: '100%' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 40, alignItems: 'center' }}
          ...
          <motion.div variants={containerVariants} initial="hidden" animate="visible">
            ...
            <motion.h1 variants={itemVariants} style={{
              ...
              lineHeight: 1.1, marginBottom: 8, color: 'var(--text-primary)',
            }}>
              Hi, I'm{' '}
            ...
            <motion.div variants={itemVariants} style={{
              ...
              marginBottom: 20, fontWeight: 500, color: 'var(--text-secondary)',
              minHeight: '2em',
            }}>
            ...
            <motion.p variants={itemVariants} style={{
              ...
              Passionate about clean code, creative design, and building things that matter.
            </motion.p>
            ...
            <motion.div variants={itemVariants} style={{ display: 'flex', gap: 16, flexWrap: 'wrap', marginBottom: 40 }}>
              <motion.a
                ...
                style={{ display: 'inline-flex', alignItems: 'center', gap: 8, textDecoration: 'none', position: 'relative', zIndex: 1 }}
          ...
          >
            <div style={{
              ...
              <div style={{ textAlign: 'center', position: 'relative', zIndex: 1 }}>
                <div style={{ fontWeight: 700, fontSize: 18, color: 'var(--text-primary)', marginBottom: 4 }}>Jafar</div>
                <div style={{ fontSize: 12, color: '#6366f1', fontWeight: 500, marginBottom: 16 }}>Full Stack Developer</div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, marginTop: 14 }}>
                  ...
                  />
                  <span style={{ fontSize: 12, color: '#22c55e', fontWeight: 500 }}>Open to opportunities</span>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        >
          <motion.div
            ...
            style={{
              ...
              cursor: 'none', color: 'rgba(148,163,184,0.5)',
            }}
          >
            <span style={{ fontSize: 11, letterSpacing: 2, textTransform: 'uppercase', fontWeight: 500 }}>Scroll</span>
            <div style={{
              width: 24, height: 38, border: '1.5px solid rgba(148,163,184,0.3)',
