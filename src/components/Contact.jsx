...
import { FiSend, FiMail, FiMapPin, FiGithub, FiLinkedin, FiTwitter, FiInstagram } from 'react-icons/fi';
    ...
    >
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          <p style={{ color: 'var(--text-secondary)', maxWidth: 480, margin: '0 auto', fontSize: 15, lineHeight: 1.7 }}>
          ...
          >
            ...
            {[
              ...
              <motion.div
                ...
                style={{ padding: '18px 20px', marginBottom: 16, display: 'flex', alignItems: 'center', gap: 16 }}
                whileHover={{ x: 4 }}
              >
                <div style={{
                ...
                <div>
                  <p style={{ fontSize: 11, color: 'var(--text-secondary)', fontWeight: 500, marginBottom: 2, letterSpacing: 0.5 }}>
                    {label.toUpperCase()}
                  </p>
                  {href ? (
                    <a href={href} style={{ fontSize: 14, color: 'var(--text-primary)', fontWeight: 600, textDecoration: 'none' }}>
                      {value}
                    </a>
                  ) : (
                    <p style={{ fontSize: 14, color: 'var(--text-primary)', fontWeight: 600 }}>{value}</p>
                  )}
                </div>
              </motion.div>
            ))}
            ...
            <div style={{ marginTop: 28 }}>
              <p style={{ fontSize: 13, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 14, letterSpacing: 0.5 }}>
                FIND ME ON
              </p>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10 }}>
                {socials.map(({ icon, href, label, color }, i) => (
                  <motion.a
                    ...
                    whileHover={{ scale: 1.12, y: -4, color, borderColor: `${color}50`, background: `${color}12` }}
                    whileTap={{ scale: 0.92 }}
                  >
                    {icon}
                  </motion.a>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                />
                <div>
                  <p style={{ fontSize: 13, fontWeight: 700, color: '#22c55e', marginBottom: 2 }}>Available for Work</p>
                  <p style={{ fontSize: 12, color: 'var(--text-secondary)' }}>Currently accepting freelance &amp; full-time roles</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
            ...
            <div className="glass-card" style={{ padding: '32px 36px' }}>
              ...
              {submitted ? (
                ...
                >
                  ...
                  <p style={{ fontSize: 17, fontWeight: 700, color: '#22c55e', marginTop: 12 }}>Message Sent!</p>
                ...
                <form onSubmit={handleSubmit}>
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 16 }}
                    className="form-row">
                    <div>
                      <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 7, letterSpacing: 0.5 }}>
                        YOUR NAME
                      </label>
                      <input
                        id="contact-name"
